...
/******/ 		}
/******/ 		script.src = __webpack_require__.p + "assets/js/chunks/" + ({}[chunkId]||chunkId) + ".js?" + {"0":"7e913a1c28345c39009a","1":"24d2053ea80fc456607f","2":"af854fb9cb99f6e1b183"}[chunkId] + "";
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__classes_http_Client__ = __webpack_require__(38);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__classes_storage_LocalStorage__ = __webpack_require__(13);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__classes_Event__ = __webpack_require__(39);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__classes_form_Form__ = __webpack_require__(42);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__classes_Auth__ = __webpack_require__(44);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__classes_models_User__ = __webpack_require__(14);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_vue_meta__ = __webpack_require__(46);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9_vue_js_modal__ = __webpack_require__(47);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10_vue_avatar__ = __webpack_require__(48);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10_vue_avatar___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_10_vue_avatar__);
var _this = this;
...
window.TimeAgo = __webpack_require__(36);
window.TinyColor = __webpack_require__(37);
 ...
 * 绑定工具全局访问
 */
window.Client = __WEBPACK_IMPORTED_MODULE_0__classes_http_Client__["a" /* Client */];
window.Local = new __WEBPACK_IMPORTED_MODULE_1__classes_storage_LocalStorage__["a" /* LocalStorage */]();
window.Event = new __WEBPACK_IMPORTED_MODULE_2__classes_Event__["a" /* default */]();
window.Form = __WEBPACK_IMPORTED_MODULE_3__classes_form_Form__["a" /* default */];
window.Auth = new __WEBPACK_IMPORTED_MODULE_4__classes_Auth__["a" /* default */]();
...
window.Model = {
	User: __WEBPACK_IMPORTED_MODULE_5__classes_models_User__["a" /* default */]
 ...
 * @param baseUrl
 */
__WEBPACK_IMPORTED_MODULE_6_vue___default.a.prototype.makeClient = function (baseUrl) {
	// 绑定api客户端实例
	_this.$client = new __WEBPACK_IMPORTED_MODULE_0__classes_http_Client__["a" /* Client */](baseUrl);
	// 全局访问
	window.Client = _this.$client;
};

__WEBPACK_IMPORTED_MODULE_6_vue___default.a.prototype.$event = window.Event;

/**
 * 创建唯一app
 */
window.$app = new __WEBPACK_IMPORTED_MODULE_6_vue___default.a({
	data: {
		user: window.Auth.user,
		authenticated: window.Auth.checkAuthentication()
	},
	methods: {
		toggleUserState: function toggleUserState(loggedIn) {
	...
	created: function created() {
		...
		this.$event.listen(this.$event.types.UserLoggedIn, function () {
			_this2.toggleUserState(true);
		});

		this.$event.listen(this.$event.types.UserLoggedOut, function () {
			_this2.toggleUserState(false);
		});
	}
});
__WEBPACK_IMPORTED_MODULE_6_vue___default.a.prototype.$app = window.$app;
...
__WEBPACK_IMPORTED_MODULE_6_vue___default.a.use(__WEBPACK_IMPORTED_MODULE_8_vue_meta___default.a);
...
__WEBPACK_IMPORTED_MODULE_6_vue___default.a.use(__WEBPACK_IMPORTED_MODULE_9_vue_js_modal___default.a);
...
__WEBPACK_IMPORTED_MODULE_6_vue___default.a.component('avatar', __WEBPACK_IMPORTED_MODULE_10_vue_avatar___default.a);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__views_App__ = __webpack_require__(50);
...
__WEBPACK_IMPORTED_MODULE_0_vue___default.a.component('logo', __webpack_require__(71));
...
var getClient = function getClient() {
	...
	var client = __WEBPACK_IMPORTED_MODULE_0_axios___default.a.create(options);
...
var Client = function () {
	...
	_createClass(Client, [{
		...
		value: function request(type, url) {
			...
			return this.client[type](url, conf).then(function (response) {
 ...
 */
/* unused harmony default export */ var _unused_webpack_default_export = ({
	request: function request(type, url) {
		var conf = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {};

		return getClient()[type](url, conf).then(function (response) {
			return Promise.resolve(response);
		}).catch(function (error) {
			return Promise.reject(error);
		});
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__FormErrors__ = __webpack_require__(43);
var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();
   ...
   */
		...
		value: function submit(requestType, url) {
			...
			return new Promise(function (resolve, reject) {
				Client.request(requestType, url, _this.data()).then(function (_ref) {
					var data = _ref.data;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__storage_LocalStorage__ = __webpack_require__(13);
var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();
...
var Local = new __WEBPACK_IMPORTED_MODULE_1__storage_LocalStorage__["a" /* LocalStorage */]();
...
var Auth = function () {
	...
	function Auth() {
		...
		this.user = __WEBPACK_IMPORTED_MODULE_0__models_User__["a" /* default */].parse(Local.get(Local.keys.OAuth.User));
	}
  ...
  */
   ...
   */
		...
		value: function fetchUser() {
			...
			Client.get('/me').then(function (_ref) {
				var data = _ref.data;

				_this.user = __WEBPACK_IMPORTED_MODULE_0__models_User__["a" /* default */].parse(data);
			}).catch(function (error) {});
		}
   ...
   */
		...
		value: function logout() {
			Client.post('/logout').then(function () {});
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__app_Hero_vue__ = __webpack_require__(52);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__app_Hero_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__app_Hero_vue__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_modals_LoginModal_vue__ = __webpack_require__(58);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_modals_LoginModal_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__components_modals_LoginModal_vue__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__AppFooter__ = __webpack_require__(61);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_modals_ComposeThreadModal__ = __webpack_require__(64);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_modals_ComposeThreadModal___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3__components_modals_ComposeThreadModal__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__components_modals_RegisterModal__ = __webpack_require__(67);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__components_modals_RegisterModal___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4__components_modals_RegisterModal__);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
	components: { AppFooter: __WEBPACK_IMPORTED_MODULE_2__AppFooter___default.a, Hero: __WEBPACK_IMPORTED_MODULE_0__app_Hero_vue___default.a, LoginModal: __WEBPACK_IMPORTED_MODULE_1__components_modals_LoginModal_vue___default.a, RegisterModal: __WEBPACK_IMPORTED_MODULE_4__components_modals_RegisterModal___default.a, ComposeThreadModal: __WEBPACK_IMPORTED_MODULE_3__components_modals_ComposeThreadModal___default.a },
	props: {
		app: {
			type: Object,
			default: null
	...
	metaInfo: function metaInfo() {
		...
		return {
			...
			titleTemplate: function titleTemplate(titleChunk) {
				// 设置后台管理页面标题格式
				return titleChunk + ' - ' + _this.app.name;
			}
		};
	},
	created: function created() {
...
Component.options.__file = "resources/assets/js/views/app/Hero.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-20497ffb", Component.options)
  } else {
    hotAPI.reload("data-v-20497ffb", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Navbar_vue__ = __webpack_require__(54);
...
Component.options.__file = "resources/assets/js/views/app/Navbar.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-39da4a5e", Component.options)
  } else {
    hotAPI.reload("data-v-39da4a5e", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        ...
        logoutDidClick: function logoutDidClick() {
        ...
        [
          _c(
            ...
            [
              _c(
                "transition",
                { attrs: { name: "slide-right-fade", mode: "out-in" } },
                [
                  _vm.$app.authenticated
                    ? _c("div", { key: "user", staticClass: "navbar-item" }, [
                        _c(
                          "div",
                          {
                            staticClass: "dropdown",
                            class: { "is-active": _vm.dropdownOpen }
                          },
                          [
                                  ...
                                  _c(
                                    "a",
                                    {
                                      ...
                                      on: {
                                        click: function($event) {
                                          $event.preventDefault()
                                          return _vm.logoutDidClick($event)
                                        }
                                      }
                                    },
                                    [
                    ...
                    : _c("div", { key: "guest", staticClass: "navbar-item" }, [
                        _c(
                          "a",
                          {
                            staticClass:
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-39da4a5e", module.exports)
  }
}
...
var render = function() {
  ...
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("section", { staticClass: "hero is-small is-primary is-bold" }, [
        ...
        _c("div", { staticClass: "container" }, [
          _c(
            ...
            [
              ...
              _c(
                "router-link",
                { attrs: { tag: "li", to: { name: "rank" } } },
                [
                  _c(
                    "a",
                    { staticClass: "navbar-item", attrs: { href: "/rank" } },
                    [
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-20497ffb", module.exports)
  }
}
...
Component.options.__file = "resources/assets/js/components/modals/LoginModal.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-3511eba6", Component.options)
  } else {
    hotAPI.reload("data-v-3511eba6", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
    ...
    [
      _c("div", { staticClass: "box" }, [
        _c(
          "div",
          {
            staticClass: "partition pb-4 flex flex-col items-center",
            attrs: { id: "partition-register" }
          },
          [
            _c("logo"),
            _vm._v(" "),
            _c(
              ...
              {
                staticClass:
                  "partition-title text-2xl has-text-weight-bold has-text-primary"
              },
              [_vm._v("账号登陆")]
            ),
            _vm._v(" "),
            _c("div", { staticClass: "partition-form w-full" }, [
              _c(
                "form",
                {
                  attrs: { method: "POST" },
                ...
                [
                    ...
                    _c(
                      ...
                      [
                        ...
                        _vm.form.errors.has("email")
                          ? _c(
                              "p",
                              { staticClass: "help is-danger text-sm mt-3" },
                    ...
                    _c(
                      ...
                      [
                        _c("input", {
                          ...
                          staticClass: "input",
                          class: {
                            "text-red-light": _vm.form.errors.has("password")
                          },
                          attrs: {
                            id: "login-password",
                            type: "password",
                  ...
                  _vm._v(" "),
                  _c("div", { staticClass: "button-set flex my-5 -mx-2" }, [
                    _c(
                      "a",
                      {
                        staticClass:
                          "button is-primary flex-1 mx-2 text-sm rounded-full",
                        class: { "is-loading": _vm.form.loading },
                        on: {
                          click: function($event) {
                            $event.preventDefault()
                            return _vm.onSubmitForm($event)
                    ...
                    _c(
                      ...
                      {
                        staticClass:
                          "button is-light flex-1 mx-2 text-sm rounded-full",
                        on: {
                          click: function($event) {
                            $event.preventDefault()
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-3511eba6", module.exports)
  }
}
...
Component.options.__file = "resources/assets/js/views/AppFooter.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-0cb10cd9", Component.options)
  } else {
    hotAPI.reload("data-v-0cb10cd9", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
var staticRenderFns = [
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("footer", { staticClass: "footer py-10" }, [
      _c("div", { staticClass: "content has-text-centered" }, [
        _c("p", [
          _vm._v("\n            开发者："),
          _c(
            "a",
            { attrs: { href: "https://calicastle.com", target: "_blank" } },
            [_vm._v("Cali Castle")]
          ),
          _vm._v(".\n        ")
        ]),
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-0cb10cd9", module.exports)
  }
}
...
Component.options.__file = "resources/assets/js/components/modals/ComposeThreadModal.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-ba530f9a", Component.options)
  } else {
    hotAPI.reload("data-v-ba530f9a", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
var render = function() {
  ...
  return _c(
    "modal",
    {
      attrs: { name: "compose-thread", transition: "pop-out", height: "auto" }
    },
    [_c("div", { staticClass: "box" })]
  )
}
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-ba530f9a", module.exports)
  }
}
...
Component.options.__file = "resources/assets/js/components/modals/RegisterModal.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-2a4b7650", Component.options)
  } else {
    hotAPI.reload("data-v-2a4b7650", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
                    ...
                    _c(
                      ...
                      [
                        _c("input", {
                          ...
                          staticClass: "input",
                          class: {
                            "is-danger": _vm.form.errors.has("username")
                          },
                          attrs: {
                            id: "login-username",
                            type: "text",
                        ...
                        _vm.form.errors.has("username")
                          ? _c(
                              "p",
                              { staticClass: "help is-danger text-sm mt-3" },
                              [_vm._v(_vm._s(_vm.form.errors.get("username")))]
                            )
                          : _vm._e()
                      ]
                    )
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-2a4b7650", module.exports)
  }
}
...
var render = function() {
  ...
  return _c(
    "main",
    { staticClass: "flex flex-col justify-between min-h-screen" },
    [
      _c("hero"),
      _vm._v(" "),
      _c(
        "section",
        { staticClass: "section threads-section" },
        [
          _c(
            "transition",
