        ...
        <section class="section">
            <article class="media" v-for="thread in threads">
                <figure class="media-left">
                    <div class="image is-64x64 rounded-lg flex items-center justify-center" :style="{ backgroundColor: '#' + thread.channel.color, color: lightTextColor(thread.channel.color) ? '#fff' : '#111' }">
